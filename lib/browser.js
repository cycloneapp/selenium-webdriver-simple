(function() {
  ...
  _ref = [require('common-errors'), require('./selenium'), require('./util'), require('./matcher')], $err = _ref[0], $selenium = _ref[1], util = _ref[2], $match = _ref[3];
  ...
  Browser = (function() {
    ...
    Browser.prototype.fullscreen = function() {
      return this.manager().window().maximize();
    };
    ...
    Browser.prototype.quit = function() {
      ...
      if (this.client != null) {
        _then = (function(_this) {
          return function() {
            if (_this.isVerbose()) {
              util.info('trying to stop selenium-server', 'browser');
            }
    ...
    Browser.prototype._checkCapabilities = function() {
      ...
      if (this.isVerbose()) {
        util.info("determined to be capable of '" + this.browser + "'", 'browser');
      }
