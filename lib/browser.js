(function() {
  ...
  Browser = (function() {
    ...
    function Browser(config) {
      var browser, selenium, _ref;
      this.config = config;
      _ref = this.config, browser = _ref.browser, selenium = _ref.selenium, this.verbose = _ref.verbose, this.timeout = _ref.timeout;
    ...
    Browser.prototype.sleep = function() {
      return this;
    };
