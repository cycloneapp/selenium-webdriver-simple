(function() {
  var Configuration, Logger, Module, compact, df, exports, extend, first, glob, globals, include, isArray, isBool, isEmpty, isNum, isString, last, m, merge, path, prependTime, put, _, _base, _base1, _base2, _error, _i, _info, _len, _log, _ref, _succ, _warn,
    __slice = [].slice,
  ...
  exports.Modules.DefaultConfiguration = Configuration = (function(_super) {
